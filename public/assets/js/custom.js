					...
					$.each(response.data, function(index, item) {
						...
						var newRow = `
							<tr>
								...
								<td><span class="morning text-center">${item.time}</span></td>
								...
								<td class="font-weight-bold">
									...
									<button data-toggle="modal" 
										...
										<button >
											<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="rgba(255,255,255,1)"><path d="M12.8995 6.85453L17.1421 11.0972L7.24264 20.9967H3V16.754L12.8995 6.85453ZM14.3137 5.44032L16.435 3.319C16.8256 2.92848 17.4587 2.92848 17.8492 3.319L20.6777 6.14743C21.0682 6.53795 21.0682 7.17112 20.6777 7.56164L18.5563 9.68296L14.3137 5.44032Z"></path></svg>
									</button>
									</div>
								</td>
							</tr>
					...
					if(response.length > 0){
						...
						$.each(response, function(index, user) {
							...
							var newRow = `<tr>
								...
								<td>${user.email}</td>
								<td class="text-center"><button class="btn btn-pill btn-success text-center mx-auto">${user.status}</button></td>
								<td class="font-weight-bold">
									<button data-toggle="modal" 
